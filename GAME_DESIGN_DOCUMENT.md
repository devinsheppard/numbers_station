...
## Milestone 008 Boundary

Milestone 008 changes only framebuffer presentation and diagnostics.
...
- Draws every state into a hidden framebuffer
- Presents completed frames at vertical blank
- Alternates two 640×448, 32-bit framebuffers
- Preserves player movement and state behavior
